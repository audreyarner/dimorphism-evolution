...
EntireSample <- read.table("BodyFatPercentwithPDIFF.FDR.tsv", header = TRUE)
...
PdiffCutoff <- read.table("BodyFatPercentPdiff4.tsv", header = TRUE)
...
write.table(GeneTable, "BodyFatPercentPdiff4Permutation.tsv")

FinishedTable <- read.table("BodyFatPercentPdiff4Permutation.tsv")
...
PdiffCutoff <- read.table("BodyFatPercentPdiff3.tsv", header = TRUE)
...
write.table(GeneTable, "BodyFatPercentPdiff3Permutation.tsv")

FinishedTable <- read.table("BodyFatPercentPdiff3Permutation.tsv")
...
PdiffCutoff <- read.table("BodyFatPercentPdiff2.tsv", header = TRUE)
...
write.table(GeneTable, "BodyFatPercentPdiff2Permutation.tsv")

FinishedTable <- read.table("BodyFatPercentPdiff2Permutation.tsv")
...
PdiffCutoff <- read.table("BodyFatPercentPdiff1.tsv", header = TRUE)
...
write.table(GeneTable, "BodyFatPercentPdiff1Permutation.tsv")

FinishedTable <- read.table("BodyFatPercentPdiff1Permutation.tsv")

CalcPercent <- FinishedTable %>% filter(x>signumber)

PercentTable[4] <- (nrow(CalcPercent)/10000)

write.table(PercentTable, "BodyFatPercentPermutationPercentile.tsv")
write.table(NumberGenes, "BodyFatPercentNumberGenesPdiff.tsv")
