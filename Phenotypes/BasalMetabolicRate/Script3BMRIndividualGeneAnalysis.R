...
EntireSample <- read.table("BMRwithPDIFF.FDR.tsv", header = TRUE)
...
PdiffCutoff <- read.table("BMRPdiff4.tsv", header = TRUE)
...
write.table(GeneTable, "BMRPdiff4Permutation.tsv")

FinishedTable <- read.table("BMRPdiff4Permutation.tsv")
...
PdiffCutoff <- read.table("BMRPdiff3.tsv", header = TRUE)
...
write.table(GeneTable, "BMRPdiff3Permutation.tsv")

FinishedTable <- read.table("BMRPdiff3Permutation.tsv")
...
PdiffCutoff <- read.table("BMRPdiff2.tsv", header = TRUE)
...
write.table(GeneTable, "BMRPdiff2Permutation.tsv")

FinishedTable <- read.table("BMRPdiff2Permutation.tsv")
...
PdiffCutoff <- read.table("BMRPdiff1.tsv", header = TRUE)
...
write.table(GeneTable, "BMRPdiff1Permutation.tsv")

FinishedTable <- read.table("BMRPdiff1Permutation.tsv")

CalcPercent <- FinishedTable %>% filter(x>signumber)

PercentTable[4] <- (nrow(CalcPercent)/10000)

write.table(PercentTable, "BMRPermutationPercentile.tsv")
write.table(NumberGenes, "BMRNumberGenesPdiff.tsv")
