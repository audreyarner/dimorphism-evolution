...
EntireSample <- read.table("HeightwithPDIFF.FDR.tsv", header = TRUE)
...
PdiffCutoff <- read.table("HeightPdiff4.tsv", header = TRUE)
...
write.table(GeneTable, "HeightPdiff4Permutation.tsv")

FinishedTable <- read.table("HeightPdiff4Permutation.tsv")
...
PdiffCutoff <- read.table("HeightPdiff3.tsv", header = TRUE)
...
write.table(GeneTable, "HeightPdiff3Permutation.tsv")

FinishedTable <- read.table("HeightPdiff3Permutation.tsv")
...
PdiffCutoff <- read.table("HeightPdiff2.tsv", header = TRUE)
...
write.table(GeneTable, "HeightPdiff2Permutation.tsv")

FinishedTable <- read.table("HeightPdiff2Permutation.tsv")
...
PdiffCutoff <- read.table("HeightPdiff1.tsv", header = TRUE)
...
write.table(GeneTable, "HeightPdiff1Permutation.tsv")

FinishedTable <- read.table("HeightPdiff1Permutation.tsv")

CalcPercent <- FinishedTable %>% filter(x>signumber)

PercentTable[4] <- (nrow(CalcPercent)/10000)

write.table(PercentTable, "HeightPermutationPercentile.tsv")
write.table(NumberGenes, "HeightNumberGenesPdiff.tsv")
