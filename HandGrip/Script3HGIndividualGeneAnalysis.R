...
EntireSample <- read.table("HandGripwithPDIFF.FDR.tsv", header = TRUE)
...
PdiffCutoff <- read.table("HandGripPdiff4.tsv", header = TRUE)
...
write.table(GeneTable, "HandGripPdiff4Permutation.tsv")

FinishedTable <- read.table("HandGripPdiff4Permutation.tsv")
...
PdiffCutoff <- read.table("HandGripPdiff3.tsv", header = TRUE)
...
write.table(GeneTable, "HandGripPdiff3Permutation.tsv")

FinishedTable <- read.table("HandGripPdiff3Permutation.tsv")
...
PdiffCutoff <- read.table("HandGripPdiff2.tsv", header = TRUE)
...
write.table(GeneTable, "HandGripPdiff2Permutation.tsv")

FinishedTable <- read.table("HandGripPdiff2Permutation.tsv")
...
PdiffCutoff <- read.table("HandGripPdiff1.tsv", header = TRUE)
...
write.table(GeneTable, "HandGripPdiff1Permutation.tsv")

FinishedTable <- read.table("HandGripPdiff1Permutation.tsv")

CalcPercent <- FinishedTable %>% filter(x>signumber)

PercentTable[4] <- (nrow(CalcPercent)/10000)

write.table(PercentTable, "HandGripPermutationPercentile.tsv")
write.table(NumberGenes, "HandGripNumberGenesPdiff.tsv")
